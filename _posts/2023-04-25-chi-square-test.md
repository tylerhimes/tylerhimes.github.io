...
An **A/B Test** can be described as a randomized experiment containing two groups, A & B, that receive different experiences. Within an **A/B Test**, we look to understand and measure the response of each group and this information helps drive future business decisions.
...
a) the type of data that you’re looking to test and
